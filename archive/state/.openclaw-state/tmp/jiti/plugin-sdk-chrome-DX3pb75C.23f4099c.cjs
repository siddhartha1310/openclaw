"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = rawDataToString;exports.E = exports.D = exports.C = void 0;exports.O = isLoopbackHost;exports.T = exports.S = void 0;exports._ = withCdpSocket;exports.a = resolveOpenClawUserDataDir;exports.b = void 0;exports.c = captureScreenshot;exports.d = normalizeCdpWsUrl;exports.f = snapshotAria;exports.g = getHeadersWithAuth;exports.h = fetchOk;exports.i = launchOpenClawChrome;exports.j = pickPrimaryTailnetIPv4;exports.k = pickPrimaryLanIPv4;exports.l = createTargetViaCdp;exports.m = fetchJson;exports.n = isChromeCdpReady;exports.o = stopOpenClawChrome;exports.p = appendCdpPath;exports.r = isChromeReachable;exports.s = resolveBrowserExecutableForPlatform;exports.t = getChromeWebSocketUrl;exports.u = formatAriaSnapshot;exports.v = ensureChromeExtensionRelayServer;exports.x = exports.w = void 0;exports.y = stopChromeExtensionRelayServer;var _registryDWvId1YW = require("./registry-DWvId1YW.js");
...
function pickPrimaryLanIPv4() {
  const nets = _nodeOs.default.networkInterfaces();
...
const DEFAULT_OPENCLAW_BROWSER_ENABLED = exports.E = true;
const DEFAULT_BROWSER_EVALUATE_ENABLED = exports.w = true;
const DEFAULT_OPENCLAW_BROWSER_COLOR = exports.T = "#FF4500";
const DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME = exports.D = "openclaw";
const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = exports.C = "chrome";
const DEFAULT_AI_SNAPSHOT_MAX_CHARS = exports.S = 8e4;
const DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS = exports.x = 1e4;
const DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH = exports.b = 6;
...
async function ensureChromeExtensionRelayServer(opts) {
  ...
  const sendToExtension = async (payload) => {
    ...
    if (!ws || ws.readyState !== _ws.default.OPEN) throw new Error("Chrome extension not connected");
  ...
  const broadcastToCdpClients = (evt) => {
    ...
    for (const ws of cdpClients) {
      if (ws.readyState !== _ws.default.OPEN) continue;
      ws.send(msg);
    }
  };
  ...
  wssExtension.on("connection", (ws) => {
    ...
    ws.on("message", (data) => {
      ...
      if (parsed && typeof parsed === "object" && "id" in parsed && typeof parsed.id === "number") {
        ...
        if ("error" in parsed && typeof parsed.error === "string" && parsed.error.trim()) pending.reject(new Error(parsed.error));else
...
function readDesktopExecLine(desktopPath) {
  try {
    const lines = _nodeFs.default.readFileSync(desktopPath, "utf8").split(/\r?\n/);
...
async function ensurePortAvailable(port) {
  try {
    ...
    if ((0, _errorsDsAYQPj.i)(err) && err.code === "EADDRINUSE") throw new PortInUseError(port);
    throw err;
  }
}
...
const log = (0, _execEUUDM93d.c)("browser").child("chrome");
...
function resolveOpenClawUserDataDir(profileName = DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME) {
  return _nodePath.default.join(_registryDWvId1YW.g, "browser", profileName, "user-data");
}
