...
const VERSION = exports.v = typeof __OPENCLAW_VERSION__ === "string" && __OPENCLAW_VERSION__ || process.env.OPENCLAW_BUNDLED_VERSION || resolveVersionFromModuleUrl("file:///D:/workspace/appDev/openclaw/dist/plugin-sdk/config-lDeTe_Qk.js") || "0.0.0";
