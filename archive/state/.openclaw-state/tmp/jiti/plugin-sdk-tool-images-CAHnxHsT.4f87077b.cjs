"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _execEUUDM93d = require("./exec-eUUDM93d.js");
var _imageOpsBnWrVu = require("./image-ops-BnWrVu47.js");

//#region src/agents/tool-images.ts
const MAX_IMAGE_DIMENSION_PX = 2e3;
const MAX_IMAGE_BYTES = 5 * 1024 * 1024;
const log = (0, _execEUUDM93d.c)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsBnWrVu.n)(buf);
