"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = void 0;exports.r = normalizeInboundTextNewlines;exports.t = finalizeInboundContext;var _rolldownRuntimeCbj13DAv = require("./rolldown-runtime-Cbj13DAv.js");
...
var inbound_context_exports = exports.n = /* @__PURE__ */(0, _rolldownRuntimeCbj13DAv.t)({ finalizeInboundContext: () => finalizeInboundContext });
...
function finalizeInboundContext(ctx, opts = {}) {
  ...
  const chatType = (0, _chatTypeDKb2TlGZ.t)(normalized.ChatType);
  ...
  if (opts.forceConversationLabel || !explicitLabel) {
    const resolved = (0, _conversationLabelC1Ak680S.n)(normalized)?.trim();
