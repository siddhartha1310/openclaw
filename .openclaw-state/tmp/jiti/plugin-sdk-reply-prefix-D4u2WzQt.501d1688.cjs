"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveAckReaction;exports.c = resolveIdentityNamePrefix;exports.i = resolveResponsePrefixTemplate;exports.l = resolveMessagePrefix;exports.n = createReplyPrefixOptions;exports.o = resolveEffectiveMessagesConfig;exports.r = void 0;exports.s = resolveHumanDelayConfig;exports.t = createReplyPrefixContext;var _rolldownRuntimeCbj13DAv = require("./rolldown-runtime-Cbj13DAv.js");
...
function resolveAgentIdentity(cfg, agentId) {
  return (0, _agentScopeBCNbpzc.n)(cfg, agentId)?.identity;
}
...
function resolveHumanDelayConfig(cfg, agentId) {
  ...
  const overrides = (0, _agentScopeBCNbpzc.n)(cfg, agentId)?.humanDelay;
...
var reply_prefix_exports = exports.r = /* @__PURE__ */(0, _rolldownRuntimeCbj13DAv.t)({
