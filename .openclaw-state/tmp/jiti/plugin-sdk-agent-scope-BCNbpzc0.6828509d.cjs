...
const FALLBACK_TEMPLATE_DIR = _nodePath.default.resolve(_nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///D:/workspace/appDev/openclaw/dist/plugin-sdk/agent-scope-BCNbpzc0.js")), "../../docs/reference/templates");
...
async function resolveWorkspaceTemplateDir(opts) {
  ...
  resolvingTemplateDir = (async () => {
    const moduleUrl = opts?.moduleUrl ?? "file:///D:/workspace/appDev/openclaw/dist/plugin-sdk/agent-scope-BCNbpzc0.js";
